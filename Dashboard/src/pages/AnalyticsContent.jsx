      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-[1100px] mx-auto px-8 py-7">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <div className="lg:col-span-1 h-[300px] card bg-text-main/[0.02] animate-pulse"></div>
            <div className="lg:col-span-1 h-[300px] card bg-text-main/[0.02] animate-pulse"></div>
            <div className="lg:col-span-1 h-[300px] card bg-text-main/[0.02] animate-pulse"></div>
            <div className="lg:col-span-2 h-[300px] card bg-text-main/[0.02] animate-pulse"></div>
            <div className="lg:col-span-1 h-[300px] card bg-text-main/[0.02] animate-pulse"></div>
            <div className="lg:col-span-3 h-[160px] card bg-text-main/[0.02] animate-pulse"></div>
          </div>
        </div>
      </main>
    );
    ...
    <main className="flex-1 overflow-y-auto">
      <div className="max-w-[1100px] mx-auto px-8 py-7">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          {/* Top Row: Weekly Trend (spans all 3) */}
          <div className="lg:col-span-3 flex flex-col">
            <WeeklyTrendChart data={data} />
          </div>

          {/* Bottom Row: Heatmap (spans all 3) */}
          <div className="lg:col-span-3 flex flex-col">
